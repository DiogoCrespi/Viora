...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, email: $email, passwordHash: $passwordHash, passwordSalt: $passwordSalt, createdAt: $createdAt, lastLogin: $lastLogin, isActive: $isActive)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, email, passwordHash,
      passwordSalt, createdAt, lastLogin, isActive);
